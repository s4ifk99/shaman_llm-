...
url: "https://sentencingcouncil.org.uk/guidelines/driving-or-attempting-to-drive-with-a-specified-drug-above-the-specified-limit/"
title: "Driving or Attempting to Drive with a specified drug above the specified limit"
guideline_type: "offence"
court: magistrates
acts: "- Road Traffic Act 1988, s.5A"
collection: "Motoring offences"
tags: ["drugs", "drug", "drug drive", "RTA", "drug driving", "attempt to drive", "be in charge", "drug attempt to drive", "drugs be in charge", "drugs driving", "s.5A", "s5a", "section 5A", "RT88584", "RT88585", "RT88586", "s5A. s.5A", "attempt drive", "drugs drive"]
...
(b) being a vehicle not so adapted, is used for carrying passengers for hire or reward at separate fares in the course of a business of carrying passengers.
  ...
  * \- For these purposes where the following pairs of drugs appear together they shall be treated as one drug as they may appear in the body as a result of a single drug use: Cocaine and benzoylecgonine (BZE); 6-Monoacteyl-morphine and morphine.

\- Trace levels of alcohol or drugs, which may occur naturally in the body or through accidental exposure, should be disregarded for these purposes

\- Regard should be had to totality (see step 5) if sentencing for more than one offence.
