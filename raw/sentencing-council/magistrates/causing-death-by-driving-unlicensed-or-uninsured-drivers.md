...
url: "https://sentencingcouncil.org.uk/guidelines/causing-death-by-driving-unlicensed-or-uninsured-drivers/"
title: "Causing death by driving: unlicensed or uninsured drivers"
guideline_type: "offence"
court: magistrates
acts: "- Road Traffic Act 1988, s.3ZB"
collection: "Motoring offences"
tags: ["s.3ZB", "s3ZB", "section 3ZB", "RA88042"]
...
#### C
  ...
  * Driving whilst unlicensed or uninsured by pressure, coercion or intimidation (where not amounting to a defence)
...
**Category range  
** 36 weeks to 2 years’ custody |  **Category range  
...
#### Other aggravating factors:
  ...
  * Serious injury to one or more victims, in addition to the death(s) (see step 5 on totality when sentencing for more than one offence)
...
For this offence, the court has discretion to disqualify until an extended driving test is passed. The discretion to order an extended re-test is likely to be exercised where there is evidence of inexperience, incompetence or infirmity, or the disqualification period is lengthy (that is, the offender is going to be ‘off the road’ for a considerable time). Where an offender has an extended driving test that is still outstanding, the court cannot order another extended re-test.
