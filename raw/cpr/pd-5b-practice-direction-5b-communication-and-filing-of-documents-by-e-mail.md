...
url: "https://www.justice.gov.uk/courts/procedure-rules/civil/rules/part05/pd_part05b"
title: "PRACTICE DIRECTION 5B – COMMUNICATION AND FILING OF DOCUMENTS BY E-MAIL"
rule_part: "5"
practice_direction: "5B"
section: "Scope and interpretation"
last_updated: "Sunday, 1 October 2023"
...
Technical specifications| Para. 3.1
Further provisions| Para. 4.1
Statements of truth| Para. 5.1
E-mail addresses of bodies| Para 6
...
(The e-mail guidance can be found at: [https://www.justice.gov.uk/courts/email-guidance#canfile (opens in a new tab)](http://aka.justice.gov.uk/courts/email-guidance#canfile))

(b) 'specified e-mail address' means the email address for a court office which has been published on the Courts and Tribunals Finder website at: <https://courttribunalfinder.service.gov.uk/courts/>[ (opens in a new tab)](https://courttribunalfinder.service.gov.uk/courts/); and
...
(Further information about using the Fee Account service may be found at: [https://www.justice.gov.uk/courts/fees/payment-by-account (opens in a new tab)](http://hmctsformfinder.justice.gov.uk/HMCTS/GetForm.do?court_forms_id=3000))
...
(Court forms may be downloaded from HMCTS website at: <http://hmctsformfinder.justice.gov.uk/HMCTS/FormFinder.do>[ (opens in a new tab)](http://hmctsformfinder.justice.gov.uk/HMCTS/FormFinder.do))
