...
title: "PRACTICE DIRECTION 7B – PRODUCTION CENTRE"
rule_part: "7"
practice_direction: "7C"
section: "General"
...
Powers of the officer to make orders| Para. 5.1
Filing separate particulars of claim| Para. 5.2
Online response| Para. 5.2A
Procedure on the filing of a defence| Para. 5.3
...
(iii) on receipt of a counterclaim, which, for the purposes of rule 26.3, will be the
relevant time, sending the proceedings in accordance with rule 26.3(3) and
(4);
...
(4) subject to paragraph 5.2C, a counterclaim (to be filed together with a defence), may, instead of filing a written form, do so by completing and sending the relevant online form at [www.moneyclaim.gov.uk/web/mcol/welcome (opens in a new tab)](http://www.moneyclaim.gov.uk/web/mcol/welcome).
